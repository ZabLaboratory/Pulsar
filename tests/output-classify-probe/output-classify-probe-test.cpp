...
int main()
{
	...
	assert(classify_output_failure(false, 0, nullptr) == nullptr);
	assert(classify_output_failure(true, 0, nullptr) == nullptr);
	...
	assert(strcmp(classify_output_failure(false, -2, "Authentication failed"), "auth_rejected") == 0);
	assert(strcmp(classify_output_failure(false, -3, "unauthorized"), "auth_rejected") == 0);
	assert(strcmp(classify_output_failure(false, -2, "invalid stream key"), "auth_rejected") == 0);
	assert(strcmp(classify_output_failure(false, -2, "403 Forbidden"), "auth_rejected") == 0);
	...
	assert(strcmp(classify_output_failure(false, -2, nullptr), "ingest_unreachable") == 0);
	...
	assert(strcmp(classify_output_failure(false, -3, nullptr), "ingest_dropped") == 0);
	assert(strcmp(classify_output_failure(false, -5, nullptr), "ingest_dropped") == 0);
	print_scenario("ingest-dropped-midstream", "stream", "active", -5, nullptr);

	// encoder_failed -- OBS_OUTPUT_ENCODE_ERROR.
	assert(strcmp(classify_output_failure(false, -8, nullptr), "encoder_failed") == 0);
	...
	assert(strcmp(classify_output_failure(false, -1, nullptr), "config_rejected") == 0);
	assert(strcmp(classify_output_failure(false, -6, nullptr), "config_rejected") == 0);
	assert(strcmp(classify_output_failure(false, -9, nullptr), "config_rejected") == 0);
	...
	assert(strcmp(classify_output_failure(true, -8, "should not matter"), "disconnected_local") == 0);
	assert(strcmp(classify_output_failure(true, -1, nullptr), "disconnected_local") == 0);
	...
	assert(strcmp(classify_output_failure(false, -4, nullptr), "unknown") == 0);
	assert(strcmp(classify_output_failure(false, -7, "No space left on device"), "unknown") == 0);
