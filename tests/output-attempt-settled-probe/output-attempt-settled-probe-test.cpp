...
int main()
{
	...
	PULSAR_CHECK(attempt_reason_class(/*live=*/true, false, 0, nullptr) == nullptr);
	PULSAR_CHECK(attempt_reason_class(/*live=*/true, true, -8, "should not matter") == nullptr);
	...
	PULSAR_CHECK(strcmp(attempt_reason_class(false, false, -2, "invalid stream key"), "auth_rejected") == 0);
	...
	PULSAR_CHECK(strcmp(attempt_reason_class(false, false, -2, nullptr), "ingest_unreachable") == 0);
	...
	// started.
	PULSAR_CHECK(strcmp(attempt_reason_class(false, false, -4, "rtmp_custom: url must be rtmp:// or rtmps://"),
		      "unknown") == 0);
	...
	PULSAR_CHECK(strcmp(attempt_reason_class(false, true, -1, nullptr), "disconnected_local") == 0);
