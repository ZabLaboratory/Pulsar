...
PATCH = ROOT / "patches" / "0027-perf-win-dshow-bulk-copy-tight-nv12.patch"
...
def test_tight_stride_fastpath_preserves_padded_fallback() -> None:
    ...
    # The exact-stride branch must return before the original padded-row loop;
    # no unchecked bulk copy may be introduced for strided input.
